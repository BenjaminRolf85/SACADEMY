      ...
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            ...
            <p className="text-gray-600">{user.position} at {user.company || 'Unknown'}</p>
          </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">{user.level}</dd>
                    </dl>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-2 max-w-xl text-sm text-gray-500">
                <p>Welcome to your Sales Academy dashboard. Here you can track your progress and access training materials.</p>
              </div>
              <div className="mt-5">
                  ...
                  <div className="flex">
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-green-700">
                        <p>You have successfully logged in with: {user.email}</p>
                      </div>
                    </div>
                  </div>
                </div>
